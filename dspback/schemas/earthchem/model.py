...
#   timestamp: 2022-07-08T19:23:44+00:00
...
class RelatedResourceItem1(BaseModel):
    identifiers: Optional[List[Union[Identifier1, Identifier2, Identifier3, Identifier4]]] = Field(
        None, title='Related Information'
    )


class RelatedResource(BaseModel):
    __root__: Union[RelatedResourceItem, RelatedResourceItem1] = Field(..., title='Related Resource')
...
class Record(BaseModel):
    ...
    contributors: Optional[List[Contributor]] = Field(None, max_items=3, title='Co-Authors')
    ...
    relatedResources: Optional[List[RelatedResource]] = Field(None, title='Related Resources')
    fundings: Optional[
        List[
            Union[
                Union[
