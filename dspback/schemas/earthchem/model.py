...
#   timestamp: 2022-05-26T20:46:12+00:00
...
class LicenseItem(BaseModel):
    name: Optional[str] = 'Creative Commons Attribution-NonCommercial-Share Alike 3.0 United States'
    alternateName: Optional[str] = 'CC-BY-NC-SA-3.0'


class LicenseItem1(BaseModel):
    name: Optional[str] = 'Creative Commons Attribution 4.0 International'
    alternateName: Optional[str] = 'CC-BY-4.0'


class LicenseItem2(BaseModel):
    name: Optional[str] = 'Creative Commons Attribution-ShareAlike 4.0 International'
    alternateName: Optional[str] = 'CC-BY-SA-4.0'


class LicenseItem3(BaseModel):
    name: Optional[str] = 'Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International'
    alternateName: Optional[str] = 'CC-BY-NC-SA-4.0'


class LicenseItem4(BaseModel):
    name: Optional[str] = 'Creative Commons No Rights Reserved'
...
class LeadAuthor(BaseModel):
    ...
    email: EmailStr
    identifiers: Optional[List[AuthorIdentifier]] = None
    affiliation: Optional[Affiliation1] = None
...
class Record(BaseModel):
    ...
    # TODO - contact earthchem about this property, it is not being returned
