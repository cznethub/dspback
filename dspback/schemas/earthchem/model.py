...
#   timestamp: 2022-04-28T16:50:26+00:00
...
class Creator(BaseModel):
    familyName: str = Field(..., title='Family Name')
    additionalName: Optional[str] = Field(None, title='Additional Name')
    givenName: str = Field(..., title='Given Name')
...
class Record(BaseModel):
    ...
    creators: List[Creator] = Field(..., title='Lead Authors')
