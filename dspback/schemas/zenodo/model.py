...
#   timestamp: 2022-03-12T02:05:21+00:00
...
class Community(BaseModel):
    identifier: Optional[str] = Field(
        None, description='The community identifier', title='Identifier'
    )
...
class ZenodoDatasetsSchemaForCzNetV100(BaseModel):
    ...
    keywords: List[str] = Field(
        ..., description='Free text keywords.', min_items=2, title='Keywords'
    )
    ...
    publication_date: Optional[date] = Field(
        None, description='', title='Publication date'
    )
