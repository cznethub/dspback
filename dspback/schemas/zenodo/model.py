...
#   timestamp: 2022-03-12T02:25:13+00:00
...
class Grant(BaseModel):
    ...
    id: str = Field(
        ...,
        description='OpenAIRE-supported grant identifier (i.e. 10.13039/501100000780::283595).',
        title='Grant Identifier with DOI prefix',
    )
...
class ZenodoDatasetsSchemaForCzNetV100(BaseModel):
    ...
    keywords: List[str] = Field(..., description='Free text keywords.', min_items=2, title='Keywords')
