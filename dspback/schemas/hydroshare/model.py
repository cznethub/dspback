...
#   timestamp: 2022-05-12T17:48:47+00:00
...
class License1(Enum):
    Creative_Commons_Attribution_CC_BY = 'Creative Commons Attribution CC BY'
    Creative_Commons_Attribution_ShareAlike_CC_BY_SA = 'Creative Commons Attribution-ShareAlike CC BY-SA'
    Creative_Commons_Attribution_NoDerivs_CC_BY_ND = 'Creative Commons Attribution-NoDerivs CC BY-ND'
    Creative_Commons_Attribution_NoCommercial_ShareAlike_CC_BY_NC_SA = (
        'Creative Commons Attribution-NoCommercial-ShareAlike CC BY-NC-SA'
    )
    Creative_Commons_Attribution_NoCommercial_CC_BY_NC = 'Creative Commons Attribution-NoCommercial CC BY-NC'
    Creative_Commons_Attribution_NoCommercial_NoDerivs_CC_BY_NC_ND = (
...
class License(BaseModel):
    ...
    _statement_prefix = "This resource is shared under the "

    @classmethod
    def from_statement(cls, statement):
        stripped_statement = statement.strip(cls._statement_prefix)
        try:
            License1(stripped_statement)
        except ValueError:
            return None
        return stripped_statement

    def as_rights(self):
        return Rights(statement=self.statement, url=self.url)

    @property
    def statement(self):
        return self._statement_prefix + self.license.value

    @property
    def url(self):
        license_id: str = self.license.value.split(" CC ")[1]
        license_id = license_id.lower()
        return f'https://creativecommons.org/licenses/{license_id}/4.0/'
...
class ResourceMetadata(BaseModel):
    ...
    rights: Union[License, Rights] = Field(
        ...,
